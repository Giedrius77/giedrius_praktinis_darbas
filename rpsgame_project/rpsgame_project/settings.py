"""
Django settings for rpsgame_project project.
...
SECRET_KEY = 'django-insecure-s((7d)3l+-c%kwrx#02d!py56m45kfq1%(s4fr(u^7!)an%z6('
...
ROOT_URLCONF = 'rpsgame_project.urls'
...
WSGI_APPLICATION = 'rpsgame_project.wsgi.application'
...
USE_I18N = True
USE_L10N = True # ijungia kalendoriu, laiku ir t.t. formatavimas pagal tos salies taisykles
USE_TZ = True
